...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  Yakyn Mini App - Dev Deployment${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo -e "${BLUE}Starting dev container from GitHub registry...${NC}"
docker-compose up -d
...
if [ $? -eq 0 ]; then
    ...
    echo -e "${GREEN}========================================${NC}"
    echo ""
    echo -e "Container: ${BLUE}yakyn-mini-app-dev${NC}"
    echo -e "Port: ${BLUE}http://localhost:10311${NC}"
    echo ""
    echo -e "Commands:"
    echo -e "  ${YELLOW}docker logs -f yakyn-mini-app-dev${NC} - View logs"
