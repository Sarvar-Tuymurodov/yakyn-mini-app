...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  Yakyn Mini App - Production Deployment${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo -e "${BLUE}Starting production container from GitHub registry...${NC}"
docker-compose up -d
...
if [ $? -eq 0 ]; then
    ...
    echo -e "${GREEN}========================================${NC}"
    echo ""
    echo -e "Container: ${BLUE}yakyn-mini-app-prod${NC}"
    echo -e "Port: ${BLUE}http://localhost:10312${NC}"
    echo ""
    echo -e "Commands:"
    echo -e "  ${YELLOW}docker logs -f yakyn-mini-app-prod${NC} - View logs"
